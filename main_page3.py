...
img = ImageTk.PhotoImage(Image.open("project_images/cricket.jpeg").resize((400,200), Image.ANTIALIAS))
image = Label(root, image = img).grid(row = 0, column = 0, sticky = W, pady = 20,padx=220)
Label_2=Label(root, text="Cricket",width=20,font=("bold", 15)).place(x=400,y=10)
...
img_2 = ImageTk.PhotoImage(Image.open("project_images/tennis.jpeg").resize((400,200), Image.ANTIALIAS))
image_2 = Label(root, image = img_2).grid(row = 5, column = 0, sticky = W, pady = 20,padx=220)
Label_3=Label(root, text="Tennis",width=20,font=("bold", 15)).place(x=400,y=320)
